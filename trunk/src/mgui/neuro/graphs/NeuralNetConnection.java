...
public class NeuralNetConnection extends DefaultGraphEdge {
	...
	public NeuralNetConnection(NeuralNetNode from, NeuralNetNode to) {
		super(from, to);
	}
	
	public double getWeight(){
		return ((NeuralNetNode)from).getWeight((NeuralNetNode)to);
	}
	
	//TODO: make more flexible in terms of what can be displayed as a label
	public String getLabel(){
		return new String(MguiDouble.getString(getWeight(), "##0.000"));
	}
